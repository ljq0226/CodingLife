...
To produce a response from Middleware, you should `rewrite` to a route ([Page](pages.md) or [Edge API Route](/docs/api-routes/edge-api-routes.md)) that produces a response.
