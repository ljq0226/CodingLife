...
Next.js compiles CSS for its [built-in CSS support](built-in-css-support.md) using PostCSS.
...
You can learn more about [Next.js' CSS Module support here](built-in-css-support.md).
