...
Shallow routing allows you to change the URL without running data fetching methods again, that includes [`getServerSideProps`](docs/01%20basic-features/data-fetching/get-server-side-props.md), [`getStaticProps`](docs/01%20basic-features/data-fetching/get-static-props.md), and [`getInitialProps`](/docs/api-reference/data-fetching/get-initial-props.md).
